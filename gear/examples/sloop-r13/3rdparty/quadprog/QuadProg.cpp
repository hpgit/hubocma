                      ...
                      double x[])
{
  ...
  double t, t1, t2; /* t is the step lenght, which is the minimum of the partial step length t1 
    * and the full step length t2 */
	...
	double (*R)[MATRIX_DIM] = new double[n][MATRIX_DIM];
	double *s = new double [m+p];
	double *z = new double [n];
	double *r = new double [m+p];
	double *d = new double [n];
	double (*J)[MATRIX_DIM] = new double[n][MATRIX_DIM];
	...
	//delete [] R; delete s; delete z; delete r; delete d; delete [] J; delete np; delete u; delete x_old; delete u_old; delete A; delete A_old; delete iai; delete iaexcl;
