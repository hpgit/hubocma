...
void HuboVpController::addQpObj(Eigen::MatrixXd &_W, Eigen::VectorXd &_a)
{
	W += _W;
	a += _a;
}

void HuboVpController::solveQp(Eigen::VectorXd &ddq, Eigen::VectorXd &tau, Eigen::VectorXd &lambda)
{
	//TODO:
			...
			)
{
	...
	huboVpBody->applyAllJointTorque(torques);
}
